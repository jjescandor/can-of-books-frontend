        ...
        return (
            ...
            >
                ...
                <Modal.Body className='modalBody'>
                    <Form onSubmit={this.handleSubmit}>
                        ...
                        <Form.Group controlId='formGenre'>
                            ...
                            <Form.Control className='formSelect' as='select' value={this.state.genre} onChange={this.handleGenreChange}>
                ...
                <Modal.Footer className='modalFooter'>
                    <Button onClick={this.props.updateOnHide} id='submitBtn'>Close</Button>
                </Modal.Footer>
            </Modal>
        );
    }
